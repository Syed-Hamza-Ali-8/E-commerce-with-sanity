            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8">
                    ...
                    <p className="text-gray-600 mb-6">
                        ...
                        cricket. Whether you're a seasoned professional or just starting
                        out, our products are designed to enhance your game and fuel your
                        love for cricket.
                    </p>
                ...
                <div className="mt-12 text-center">
                    ...
                    <div className="flex flex-col md:flex-row justify-center gap-8">
                        ...
                        <div className="flex flex-col items-center mb-8 md:mb-0">
                            ...
                            />
                            <p className="text-lg text-gray-800 font-semibold">Syed Hamza Ali</p>
                        ...
                        <div className="flex flex-col items-center mb-8 md:mb-0">
                            <img
                                src="/AboutSection/pic2.jpeg" // Add image path here
                                alt="Team Member 1"
                                className="w-40 h-40 lg:w-48 lg:h-48 rounded-full object-cover mb-4"
                            />
                        ...
                        <div className="flex flex-col items-center">
                            <img
                                src="/AboutSection/pic3.jpeg" // Add image path here
                                alt="Team Member 2"
                                className="w-40 h-40 lg:w-48 lg:h-48 rounded-full object-cover mb-4"
                            />
                            <p className="text-lg text-gray-800 font-semibold">Lorem ipsum</p>
