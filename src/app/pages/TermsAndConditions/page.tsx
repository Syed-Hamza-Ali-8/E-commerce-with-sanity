    ...
    <div className="bg-gray-100 py-12">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-600 text-center mb-12">
          ...
          services. Please read them carefully before using our site.
        </p>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              use of the website. Prohibited activities include:
            </p>
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              website are owned by us or licensed to us. You may not reproduce,
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              convenience. We are not responsible for the content, policies, or
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              website without notice if you violate these Terms and Conditions
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              time. Changes will be posted on this page, and your continued use
