            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    <nav className="hidden md:flex space-x-8 items-center">
                        ...
                        <Link href="/pages/About" className="text-gray-600 hover:text-gray-800">
                            About
                        </Link>
                        ...
                        <Link href="/pages/Blogs" className="text-gray-600 hover:text-gray-800">
                            Blog
                        </Link>
                        <Link href="/pages/Contact" className="text-gray-600 hover:text-gray-800">
                            Contact
                        </Link>
                    </nav>
